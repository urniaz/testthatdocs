The **testthatdocs** is one-click documentation for testthat unit tests, simply ... ![alt text](https://github.com/urniaz/blob/testthatdocs/testthatdocs/man/figures/logo.png?raw=true)
